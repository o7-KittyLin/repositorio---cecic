                        ...
                        <div class="row g-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="start_date" name="start_date" class="form-control" placeholder="Selecciona fecha" value="{{ old('start_date') }}">
                                    @error('start_date')
                                    <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" id="start_hour" name="start_hour" class="form-control" placeholder="Ej: 9:30" value="{{ old('start_hour') }}">
                                        <select id="start_period" name="start_period" class="form-select ms-2">
                                            <option value="AM" {{ old('start_period')=='AM'?'selected':'' }}>AM</option>
                                            <option value="PM" {{ old('start_period')=='PM'?'selected':'' }}>PM</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" id="end_hour" name="end_hour" class="form-control" placeholder="Ej: 11:45" value="{{ old('end_hour') }}">
                                        <select id="end_period" name="end_period" class="form-select ms-2">
                                            <option value="AM" {{ old('end_period')=='AM'?'selected':'' }}>AM</option>
                                            <option value="PM" {{ old('end_period')=='PM'?'selected':'' }}>PM</option>
                                        </select>
                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function isValidRange(t) {
            return (t.hour >= 8 && t.hour <= 12) || (t.hour >= 13 && t.hour <= 17);
        }
        ...
        function validateStart() {
            ...
            const val = startHourInput.value;
            if(!isValidFormat(val)) {
                startError.textContent = 'Formato inválido HH:MM';
                return false;
            }
        ...
        function validateEnd() {
            ...
            const val = endHourInput.value;
            if(!isValidFormat(val)) {
                endError.textContent = 'Formato inválido HH:MM';
                return false;
            }
...
<style>
    /* Mejoras visuales para Flatpickr */
    .flatpickr-calendar {
