                        ...
                        <div class="row g-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" id="start_hour" name="start_hour" class="form-control"
                                               value="{{ old('start_hour', $startHour) }}" placeholder="Ej: 9:30">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" id="end_hour" name="end_hour" class="form-control"
                                               value="{{ old('end_hour', $endHour) }}" placeholder="Ej: 11:45">
